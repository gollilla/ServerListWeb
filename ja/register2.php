...
if(!isset($_POST["mail"]) || !isset($_POST["pass"])){
    header("Refresh : 5; url=register1.html");
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="progress progress-striped active">
            ...
            <?php
             ...
             ?>
            <p>サーバーの名前を [ <?php echo($uniq);?> ] にして認証ボタンを押してください。</p> 
            <form method="post">
              ...
              <div class="form-group">
                <label>port</label>
                <input type="text" id="port" class="form-control" value='19132'>
